...
<body class="landing-page sidebar-collapse">
  ...
  <div class="wrapper">
    <div class="page-header page-header-small">
      <div class="page-header-image" data-parallax="true" style="background-image: url('img/sawah.jpg');">
      </div>
      <div class="content-center">
        <div class="container">
          <h1 class="title text-primary">Desa Bogor, Kecamatan Cawas, Kabupaten Klaten</h1>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">Mari Berkenalan dengan Desa Bogor!</h2>
            <h5 class="description">Desa Bogor berbatasan dengan Kabupaten Sukoharjo yang dibatasi Sungai Dengkeng atau lebih dikenal dengan Kreteg Jarum. Sebelah timur berbatasan dengan Kabupaten Sukoharjo, sebelah selatan dengan Desa Tlingsing, sebelah Barat dengan Desa Pogung, dan sebelah Utara dengan Kecamatan Karangdowo. Desa Bogor terdiri dari 9 dusun, 9 RW, dan 25 RT.</h5>
          </div>
        </div>
    ...
    <hr>
      ...
      <div class="section" id="carousel">
        <div class="container">
          <div class="title">
            <h4>KKN TIM II Universitas Diponegoro, 6 Juli - 19 Agustus 2023</h4>
          </div>
